...
while cap.isOpened():
    ...
    if results.multi_hand_landmarks:
        for hand_landmarks in results.multi_hand_landmarks:
            ...
            # Define conditions to detect the "C" gesture
            # Check if the thumb and index finger are extended, and the other fingers are closed
            if lm_list[4][1] < lm_list[5][1] and lm_list[8][1] < lm_list[6][1] and lm_list[12][1] > lm_list[10][1] and lm_list[16][1] > lm_list[14][1] and lm_list[20][1] > lm_list[18][1]:
                cv2.putText(frame, "C", (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 3)
                print("C")
